...
sentence form, and in the three constraints of Section~\ref{sec:desc-gen}. DCLIP+ is the relevant
...
sources. Source-grounded text, written in the register of a pathology reference and carrying
pathogen and taxonomy fields, lags by about seven points. What this licenses is narrower than a rule for
